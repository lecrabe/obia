...
train_shp_file <- paste0(train_dir,train_basename,".shp")
train_tif_file <- paste0(train_dir,train_basename,".tif")
train_dbf_file <- paste0(train_dir,train_basename,".dbf")
